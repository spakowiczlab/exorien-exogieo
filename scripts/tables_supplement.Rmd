...
write_xlsx(micim.list, "../tables/s8_correlation-summary.xlsx")
```
...
write.csv(orien.immune, "../tables/s6_orien-immune-frac.csv", row.names = F)
write.csv(TCGA.immune, "../tables/s7_tcga-immune-frac.csv", row.names = F)
```
