...
load("/fs/ess/PAS1695/projects/exogieo/data/correlation-data/TCGA-inputs.rda")
...
write.csv(cor.can, paste0("/fs/ess/PAS1695/projects/exogieo/data/correlation-data/TCGA-results_",
