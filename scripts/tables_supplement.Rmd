...
write_xlsx(s4.list, "../tables/s6_fig3-rnaseq-vol.xlsx")
```
...
write_xlsx(s5, "../tables/s7_fig-16s-vol.xlsx")
```
...
write_xlsx(micim.list, "../tables/s10_correlation-summary.xlsx")
```
...
write.csv(orien.immune, "../tables/s8_orien-immune-frac.csv", row.names = F)
write.csv(TCGA.immune, "../tables/s9_tcga-immune-frac.csv", row.names = F)
```
